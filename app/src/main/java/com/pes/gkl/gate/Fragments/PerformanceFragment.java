 ...
 */
public class PerformanceFragment extends Fragment implements OnChartGestureListener {
    ArrayList<Integer> topicStats;
    LineChart mChart;
...
//        mChart.invalidate();
    ...
    private void setData(int count, float range) {
        ...
        */
        for(int i = 0; i<count; i++)
        {
            yVals.add(new Entry(topicStats.get(i), i));
        }
